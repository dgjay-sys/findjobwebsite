...
<body>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="../view/applicantprofile.php">Profile</a></li>
    ...
    <div class="container">
        ...
        <?php
        $query = "SELECT * FROM `applicant_table` where user_id = '$userid' and post_id = '$postid' ";
        ...
        ?>
                <div class="card" style="width: 18rem;">
                    <div class="row">
                        <div class="col">
                          <?php echo '<img src="../../backend/controller/uploadedprofile/'.$_SESSION['profile'].'" class="card-img-top" alt="">'?>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">User Status: <?php echo $row['status'] ?></li>
